...
namespace pspsharp.memory
{
	...
	public class MemoryReader
	{
		...
		// The Java JIT compiler is producing slightly faster code for "sealed override" methods.
		// Added "sealed override" here only for performance reasons. Can be removed if inheritance
