	...
	public class DirectBufferMemory : Memory
	{
		...
		public override bool allocate()
		{
			...
			catch (System.OutOfMemoryException)
			{
				...
				Memory.System.Console.WriteLine("Cannot allocate DirectBufferMemory: add the option '-Xmx256m' to the Java Virtual Machine startup command to improve Performance");
