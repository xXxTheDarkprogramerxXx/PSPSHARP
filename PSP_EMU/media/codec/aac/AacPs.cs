...
//ORIGINAL LINE: private static void hybrid2_re(float in[][], float out[][][], int outOffset, sealed override float filter[], int len, int reverse)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static void hybrid6_cx(float in[][], float out[][][], int outOffset, sealed override float filter[][][], int len)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static void hybrid4_8_12_cx(float in[][], float out[][][], int outOffset, sealed override float filter[][][], int N, int len)
		...
		/// Table 8.46 </summary>
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: static void map_idx_10_to_20(int par_mapped[], sealed override int par[], bool full)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: static void map_idx_34_to_20(int par_mapped[], sealed override int par[], bool full)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: static void map_idx_10_to_34(int par_mapped[], sealed override int par[], bool full)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: static void map_idx_20_to_34(int par_mapped[], sealed override int par[], bool full)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: static void decorrelation(PSContext ps, float out[][][], sealed override float s[][][], sealed override bool is34)
...
//ORIGINAL LINE: sealed override int is34i = is34 ? 1 : 0;
			int is34i = is34 ? 1 : 0;
//JAVA TO C# CONVERTER NOTE: The following call to the 'RectangularArrays' helper class reproduces the rectangular array initialization that is automatic in Java:
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int k_to_i[] = is34 ? k_to_i_34 : k_to_i_20;
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static void stereo_processing(PSContext ps, float l[][][], float r[][][], sealed override bool is34)
...
//ORIGINAL LINE: sealed override int k_to_i[] = is34 ? k_to_i_34 : k_to_i_20;
			int[] k_to_i = is34 ? k_to_i_34 : k_to_i_20;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float H_LUT[][][] = ps.iccMode < 3 ? HA : HB;
...
//ORIGINAL LINE: float[][][] Rbuf = new float[91][32][2];
			...
			const int len = 32;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override bool is34 = ps.is34bands;
