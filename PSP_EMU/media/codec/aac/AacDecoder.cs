...
//ORIGINAL LINE: sealed override int bits = (ics.windowSequence[0] == EIGHT_SHORT_SEQUENCE) ? 3 : 5;
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int is8 = ics.windowSequence[0] == EIGHT_SHORT_SEQUENCE ? 1 : 0;
			int is8 = ics.windowSequence[0] == EIGHT_SHORT_SEQUENCE ? 1 : 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int tnsMaxOrder = is8 != 0 ? 7 : ac.oc[1].m4ac.objectType == AOT_AAC_MAIN ? 20 : 12;
		...
		private int decodeSpectrumAndDequant(float[] coef, float[] sf, bool pulsePresent, Pulse pulse, IndividualChannelStream ics, int[] bandType)
		{
			int idx = 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int c = 1024 / ics.numWindows;
			int c = 1024 / ics.numWindows;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int offsets[] = ics.swbOffset;
			...
			for (int g = 0; g < ics.numWindowGroups; g++)
			{
				...
				{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int cbtM1 = bandType[idx] == 0 ? Integer.MAX_VALUE : bandType[idx] - 1;
					...
					{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float vq[] = ff_aac_codebook_vector_vals[cbtM1];
						float[] vq = ff_aac_codebook_vector_vals[cbtM1];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int cbVertexIdx[] = ff_aac_codebook_vector_idx[cbtM1];
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override IndividualChannelStream ics = cpe.ch[0].ics;
...
//ORIGINAL LINE: sealed override int offsets[] = ics.swbOffset;
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override IndividualChannelStream ics = cpe.ch[1].ics;
			IndividualChannelStream ics = cpe.ch[1].ics;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override SingleChannelElement sce1 = cpe.ch[1];
...
//ORIGINAL LINE: sealed override int offsets[] = ics.swbOffset;
			...
			for (int g = 0; g < ics.numWindowGroups; g++)
			{
				for (int i = 0; i < ics.maxSfb;)
				{
					...
					{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int btRunEnd = sce1.bandTypeRunEnd[idx];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float swindow [] = ics.useKbWindow[0] ? ff_aac_kbd_short_128 : ff_sine_128;
			float[] swindow = ics.useKbWindow[0] ? ff_aac_kbd_short_128 : ff_sine_128;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float lwindowPrev[] = ics.useKbWindow[1] ? ff_aac_kbd_long_1024 : ff_sine_1024;
			float[] lwindowPrev = ics.useKbWindow[1] ? ff_aac_kbd_long_1024 : ff_sine_1024;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float swindowPrev[] = ics.useKbWindow[1] ? ff_aac_kbd_short_128 : ff_sine_128;
		...
		private void imdctAndWindowingEld(SingleChannelElement sce)
		{
			...
			const int n = 512;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int n2 = n >> 1;
			int n2 = n >> 1;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int n4 = n >> 2;
			int n4 = n >> 2;
...
//JAVA TO C# CONVERTER TODO TASK: The following line could not be converted:
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float lwindow [] = ics.useKbWindow[0] ? ff_aac_kbd_long_1024 : ff_sine_1024;
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int offsets[] = sce.ics.swbOffset;
			int[] offsets = sce.ics.swbOffset;

			if (sce.ics.windowSequence[0] != EIGHT_SHORT_SEQUENCE)
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float predTime[] = sce.ret;
				float[] predTime = sce.ret;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float predFreq[] = ac.bufMdct;
...
//ORIGINAL LINE: sealed override float swindow[] = ics.useKbWindow[0] ? ff_aac_kbd_short_128 : ff_sine_128;
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int mmm = Math.min(ics.tnsMaxBands, ics.maxSfb);
			int mmm = System.Math.Min(ics.tnsMaxBands, ics.maxSfb);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float lpc[] = new float[TNS_MAX_ORDER];
			float[] lpc = new float[TNS_MAX_ORDER];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float tmp[] = new float[TNS_MAX_ORDER + 1];
		...
		private void applyDependentCoupling(SingleChannelElement target, ChannelElement cce, int index)
		{
			...
			for (int g = 0; g < ics.numWindowGroups; g++)
			{
				for (int i = 0; i < ics.maxSfb; i++, idx++)
				{
					...
					{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float gain = cce.coup.gain[index][idx];
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float gain = cce.coup.gain[index][0];
			float gain = cce.coup.gain[index][0];
			float[] src = cce.ch[0].ret;
			float[] dest = target.ret;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int len = 1024 << (ac.oc[1].m4ac.sbr == 1 ? 1 : 0);
...
//ORIGINAL LINE: int[][] layoutMap = new int[MAX_ELEM_ID * 4][3];
		...
		private int decodeErFrame()
		{
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int elemType = aac_channel_layout_map[chanConfig - 1][i][0];
				int elemType = aac_channel_layout_map[chanConfig - 1][i][0];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int elemId = aac_channel_layout_map[chanConfig - 1][i][1];
