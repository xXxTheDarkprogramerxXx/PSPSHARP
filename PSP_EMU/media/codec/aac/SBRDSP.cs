...
//ORIGINAL LINE: public static void qmfDeintNeg(float v[], int vOffset, sealed override float src[], int srcOffset)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void qmfDeintBfly(float v[], int vOffset, sealed override float src0[], int src0Offset, sealed override float src1[], int src1Offset)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void hf_gen(float X_high[][], int XhighOffset, sealed override float X_low[][], int XlowOffset, sealed override float alpha0[], sealed override float alpha1[], float bw, int start, int end)
...
//ORIGINAL LINE: sealed override float alpha[] = new float[4];
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void hfGFilt(float Y[][], int Yoffset, sealed override float Xhigh[][][], int Xoffset, sealed override float gFilt[], int mMax, int ixh)
