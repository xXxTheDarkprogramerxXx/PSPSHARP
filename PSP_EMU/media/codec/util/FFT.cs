...
//ORIGINAL LINE: public void imdctHalf(float[] output, int outputOffset, sealed override float[] input, int inputOffset)
...
//ORIGINAL LINE: sealed override float[] r = new float[4];
			float[] r = new float[4];
			for (int k = 0; k < n8; k++)
			{
