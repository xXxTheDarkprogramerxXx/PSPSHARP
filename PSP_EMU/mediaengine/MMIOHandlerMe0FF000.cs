			...
			set
			{
				...
				switch (value)
				{
					case 0x02:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}", value, status));
						}
						break;
					case 0x03:
						//if (log.DebugEnabled)
					...
					case 0x04:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown10=0x{2:X8}, unknown14=0x{3:X}, unknown18=0x{4:X}", value, status, unknown10, unknown14, unknown18));
						}
						break;
					case 0x05:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown10=0x{2:X8}", value, status, unknown10));
							System.Console.WriteLine(Utilities.getMemoryDump(Memory, unknown10, 0x1A4, 4, 16));
						}
						break;
					case 0x08:
						//if (log.DebugEnabled)
					...
					case 0x1D:
						...
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, power=0x{2:X}, unknown10=0x{3:X8}", value, status, power, unknown10));
							System.Console.WriteLine(string.Format("unknown10: {0}", Utilities.getMemoryDump(Memory, unknown10, 0x2000, 4, 16)));
						}
						break;
					case 0x20:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown14=0x{2:X}, unknown18=0x{3:X}, unknown1C=0x{4:X}, unknown2C=0x{5:X}", value, status, unknown14, unknown18, unknown1C, unknown2C));
						}
						break;
					case 0x21:
						...
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown14=0x{2:X}, unknown18=0x{3:X}, unknown1C=0x{4:X}", value, status, unknown14, unknown18, unknown1C));
						}
						break;
					case 0x28:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown14=0x{2:X}, unknown18=0x{3:X}", value, status, unknown14, unknown18));
						}
						break;
					case 0x40:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown10=0x{2:X8}, unknown14=0x{3:X}, unknown18=0x{4:X}", value, status, unknown10, unknown14, unknown18));
							System.Console.WriteLine(string.Format("unknown10: {0}", Utilities.getMemoryDump(Memory, unknown10, (unknown14 + 1) << 2), 4, 16));
						}
						break;
					case 0x42:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown10=0x{2:X8}, unknown14=0x{3:X}, unknown18=0x{4:X}, unknown1C=0x{5:X}", value, status, unknown10, unknown14, unknown18, unknown1C));
						}
						break;
					case 0x45:
						//if (log.DebugEnabled)
					...
					case 0x50:
						//if (log.DebugEnabled)
						{
							System.Console.WriteLine(string.Format("Unknown command 0x{0:X}, status=0x{1:X}, unknown10=0x{2:X8}, unknown14=0x{3:X}, unknown18=0x{4:X}, unknown20=0x{5:X}, unknown24=0x{6:X}, unknown28=0x{7:X}", value, status, unknown10, unknown14, unknown18, unknown20, unknown24, unknown28));
						}
						break;
					case 0x52:
						//if (log.DebugEnabled)
					...
					case 0x58:
						...
						{
							System.Console.WriteLine(string.Format("Unknown Length 0x{0:X} in command 0x{1:X}, status=0x{2:X}, unknown10=0x{3:X8}, unknown14=0x{4:X}, unknown18=0x{5:X}, unknown20=0x{6:X}, unknown24=0x{7:X}, unknown28=0x{8:X}", unknown14, value, status, unknown10, unknown14, unknown18, unknown20, unknown24, unknown28));
						}
						else if (unknown18 != 0x9C00 || unknown20 != 0 || unknown24 != 0xFFFE || unknown28 != 0)
						{
							System.Console.WriteLine(string.Format("Unknown parameters in command 0x{0:X}, status=0x{1:X}, unknown10=0x{2:X8}, unknown14=0x{3:X}, unknown18=0x{4:X}, unknown20=0x{5:X}, unknown24=0x{6:X}, unknown28=0x{7:X}", value, status, unknown10, unknown14, unknown18, unknown20, unknown24, unknown28));
						}
						else
						{
