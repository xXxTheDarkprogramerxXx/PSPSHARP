...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: @Override public void write(sealed override int b) throws java.io.IOException
...
//ORIGINAL LINE: sealed override int newBufLength = bufLength + DEFAULT_BUFFER_LENGTH;
				int newBufLength = bufLength + DEFAULT_BUFFER_LENGTH;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override byte[] newBuf = new byte[newBufLength];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override byte[] theBytes = new byte[count];
