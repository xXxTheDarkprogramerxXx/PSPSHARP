...
//ORIGINAL LINE: public static String readStringNZ(ByteBuffer buf, int n) throws java.io.IOException
		...
		{
			// add 1 to the Length to write the sealed override '\0'
...
//ORIGINAL LINE: public static int getUnsignedByte(ByteBuffer bb) throws java.io.IOException
		...
		{
			bb.put(unchecked((byte)(value & 0xFF)));
		}
...
//ORIGINAL LINE: public static int parseInteger(String s) throws NumberFormatException
		...
		public static int parseAddressExpression(string s)
		{
			...
			if (m.Count > 0)
			{
				int offset = parseInteger(p.GroupNameFromNumber(1));
				int reg = getRegister(p.GroupNameFromNumber(3));
			...
			if (m.Count > 0)
			{
				int reg = getRegister(p.GroupNameFromNumber(1));
				int offset = parseInteger(p.GroupNameFromNumber(3));
				if (p.GroupNameFromNumber(2).Equals("-"))
				{
					offset = -offset;
				}
...
//ORIGINAL LINE: sealed override int blockSize = 16 * pspsharp.filesystems.umdiso.UmdIsoFile.sectorLength;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static String toString(java.io.InputStream inputStream, bool close) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int numberLines = Length >> 4;
			int numberLines = Length >> 4;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override char[] chars = new char[numberLines * lineTemplate.Length];
			char[] chars = new char[numberLines * lineTemplate.Length];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int lineOffset = lineSeparator.Length() + 2;
...
//ORIGINAL LINE: public static void matrixMult(sealed override float[] result, float[] m1, float[] m2)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorMult(sealed override float[] result, sealed override float[] m, sealed override float[] v)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorMult33(sealed override float[] result, sealed override float[] m, sealed override float[] v)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorMult34(sealed override float[] result, sealed override float[] m, sealed override float[] v)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorMult44(sealed override float[] result, sealed override float[] m, sealed override float[] v)
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int length4 = Length >> 2;
