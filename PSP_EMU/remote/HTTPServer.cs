...
//	import static pspsharp.util.Utilities.getDefaultPortForProtocol;
	...
	public class HTTPServer
	{
		...
		private System.Drawing.Bitmap currentDisplayImage;
...
//ORIGINAL LINE: private javax.net.ssl.SSLServerSocketFactory getSSLServerSocketFactory() throws java.security.KeyStoreException, java.security.NoSuchAlgorithmException, java.security.cert.CertificateException, java.io.IOException, java.security.UnrecoverableKeyException, java.security.KeyManagementException
		...
		private class DisplayAction : IAction
		{
			...
			{
				outerInstance.currentDisplayImage = Modules.sceDisplayModule.getCurrentDisplayAsSystem.Drawing.Bitmap(false);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private bool doProxy(pspsharp.remote.HTTPConfiguration.HttpServerConfiguration httpServerConfiguration, HTTPServerDescriptor descriptor, java.util.HashMap<String, String> request, java.io.OutputStream os, String pathValue) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private bool doProxy(HTTPServerDescriptor descriptor, java.util.HashMap<String, String> request, java.io.OutputStream os, String pathValue, int forcedPort) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private bool process(HTTPServerDescriptor descriptor, java.util.HashMap<String, String> request, java.io.OutputStream os) throws java.io.IOException
...
//ORIGINAL LINE: private void sendVideoMJPG(java.io.OutputStream os) throws java.io.IOException
		private void sendVideoMJPG(System.IO.Stream os)
		{
			...
			try
			{
				...
				while (true)
				{
					System.Drawing.Bitmap img = getScreenImage(rect);
					try
					{
						file.delete();
						ImageIO.write(img, fileFormat, file);
...
//ORIGINAL LINE: private void sendAudioRAW(java.io.OutputStream os) throws java.io.IOException
		...
		private System.Drawing.Bitmap getScreenImage(Rectangle rect)
		{
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private void sendIso(java.util.HashMap<String, String> request, java.io.OutputStream os, String pathValue, bool sendContent) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private bool isMatchingELFArchitecture(byte[] header, int Length, int machineArchitecture) throws java.io.IOException
