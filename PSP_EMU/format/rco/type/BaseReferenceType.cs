...
namespace pspsharp.format.rco.type
{
	...
	public class BaseReferenceType : BaseType
	{
		...
		protected internal System.Drawing.Bitmap image;
		...
		public override void init(RCOContext context)
		{
			switch (referenceType)
			{
				...
				case REFERENCE_TYPE_IMAGE:
					...
					break;
				default:
					System.Console.WriteLine(string.Format("BaseReferenceType: unknown referenceType 0x{0:X}({1})", referenceType, getReferenceTypeString(referenceType)));
					break;
			}
			base.init(context);
		}
