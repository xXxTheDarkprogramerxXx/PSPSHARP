    ...
    public class BasePositionObject : BaseObject, IDisplay
	{
		...
		public virtual int Width
		{
			get
			{
				...
				return (int)System.Math.Round(w * scaleWidth.FloatValue);
			}
		}
		...
		public virtual int Height
		{
			get
			{
				...
				return (int)System.Math.Round(h * scaleHeight.FloatValue);
			}
		}
		...
		public virtual System.Drawing.Bitmap Image
		{
			get
			{
				...
				if (Object.getPropertyValue(Resource.textureName) != null)
				{
		...
		public virtual int X
		{
			get
			{
				...
				return (int)(parentX + posX.IntValue + Round(animX));
			}
		}
		...
		public virtual int Y
		{
			get
			{
				...
				return(int)( parentY + posY.IntValue + Round(animY));
			}
		}
		...
		public virtual System.Drawing.Bitmap AnimImage
		{
			get
			{
				System.Drawing.Bitmap image = Image;
		...
		public virtual void setFocus()
		{
			...
			if (display != null)
			{
                display.Focus = @object.BaseObject;
			}
			if (controller != null)
			{
