...
//	import static pspsharp.HLE.modules.SysMemUserForUser.PSP_SMEM_Low;
	...
	public class VplManager
	{
		...
		//public sealed override static int PSP_VPL_ATTR_EXT =        0x8000;   // Automatically extend the VPL's memory area (when allocating a block from the VPL and the remaining size is too small, this flag tells the VPL to automatically attempt to extend it's memory area).
