...
namespace pspsharp.HLE.kernel.types
{
	...
	public class SceIoDirent : pspAbstractMemoryMappedStructure
	{
		...
		public int extendedInfoAddr; // This FieldInfo is a pointer to user data and only used by the MemoryStick driver.
		...
		protected internal override void write()
		{
			...
			// NOTE: Do not overwrite the reserved FieldInfo.
