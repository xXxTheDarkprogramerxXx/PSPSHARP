...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void save(pspsharp.Memory mem, bool secure) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private bool checkParamSFOEncryption(String path, String name) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private void writePsf(pspsharp.Memory mem, String path, String psfName, PspUtilitySavedataSFOParam sfoParam, bool cryptoMode, String dataName, byte[] key, byte[] hash) throws java.io.IOException
		private void writePsf(Memory mem, string path, string psfName, PspUtilitySavedataSFOParam sfoParam, bool cryptoMode, string dataName, sbyte[] key, sbyte[] hash)
		{
			...
			try
			{
				...
				if (cryptoMode)
				{
					...
					// Generate the sealed override SAVEDATA_PARAMS (encrypted).
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public bool test(pspsharp.Memory mem) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private bool testFile(pspsharp.Memory mem, String path, String name) throws java.io.IOException
