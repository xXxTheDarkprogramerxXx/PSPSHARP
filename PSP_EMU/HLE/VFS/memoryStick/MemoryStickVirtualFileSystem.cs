	...
	public class MemoryStickVirtualFileSystem : AbstractVirtualFileSystem
	{
		...
		public override int ioDevctl(string deviceName, int command, TPointer inputPointer, int inputLength, TPointer outputPointer, int outputLength)
		{
			...
			switch (command)
			{
				...
				case 0x02025801:
				{
					System.Console.WriteLine("ioDevctl check ms driver status");
				...
				case 0x02015804:
				{
					System.Console.WriteLine("ioDevctl register memorystick insert/eject callback (mscmhc0)");
				...
				case 0x02015805:
				{
					System.Console.WriteLine("ioDevctl unregister memorystick insert/eject callback (mscmhc0)");
					ThreadManForUser threadMan = Modules.ThreadManForUserModule;
					if (inputPointer.AddressGood && inputLength == 4)
					{
						int cbid = inputPointer.getValue32();
				...
				case 0x02025806:
				{
					System.Console.WriteLine("ioDevctl check ms inserted (mscmhc0)");
