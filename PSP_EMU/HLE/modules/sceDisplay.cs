...
//ORIGINAL LINE: System.Console.WriteLine(String.format("hleDisplaySetGeBuf topaddr=0x%08X, bufferwidth=%d, pixelformat=%d, copyGE=%b, with=%d, height=%d", topaddr, bufferwidth, pixelformat, copyGEToMemory, width, height));
	...
	//ORIGINAL LINE: System.Console.WriteLine(String.format("Save Stencil To Memory: %b", value));
		...
		public virtual System.Drawing.Bitmap getCurrentDisplayAsSystem.Drawing.Bitmap(bool needAlpha)
		{
			...
			if (UsingSoftwareRenderer)
			{
				...
				{
					image = new System.Drawing.Bitmap(width, height, System.Drawing.Bitmap.TYPE_INT_RGB);
...
//ORIGINAL LINE: sealed override int stencilPixelMask = stencilPixelMasks[ge.getPixelFormat()];
			int stencilPixelMask = stencilPixelMasks[ge.PixelFormat];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int stencilValueMask = stencilValueMasks[ge.getPixelFormat()];
			int stencilValueMask = stencilValueMasks[ge.PixelFormat];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int stencilValueShift = stencilValueShifts[ge.getPixelFormat()];
