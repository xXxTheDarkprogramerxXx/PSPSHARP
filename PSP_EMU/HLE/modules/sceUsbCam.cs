...
//	import static pspsharp.HLE.modules.sceJpeg.clamp8bit;
	...
	public class sceUsbCam : HLEModule
	{
		...
		protected internal System.Drawing.Bitmap currentVideoImage;
		...
		protected internal class VideoListener : MediaListenerAdapter
		{
			...
			{
				System.Drawing.Bitmap image = @event.Image;
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		protected internal virtual System.Drawing.Bitmap convertYUYV422toRGB(int width, int height, ByteBuffer buffer)
		{
			...
			System.Drawing.Bitmap image = new System.Drawing.Bitmap(width, height, System.Drawing.Bitmap.TYPE_INT_RGB);
		...
		protected internal virtual System.Drawing.Bitmap CurrentVideoImage
		{
			set
			{
...
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x17F7B2FB, version = 271) public int sceUsbCamSetupVideo(pspsharp.HLE.kernel.types.pspUsbCamSetupVideoParam usbCamSetupVideoParam, pspsharp.HLE.TPointer workArea, int workAreaSize)
		...
		/// <returns> 0 on success, < 0 on error </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0xF93C4669, version = 271) public int sceUsbCamAutoImageReverseSW(bool on)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x4C34F553, version = 271) public bool sceUsbCamGetLensDirection()
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x11A1F128, version = 271) public bool sceUsbCamGetAutoImageReverseState()
