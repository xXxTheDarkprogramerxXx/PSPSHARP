...
//ORIGINAL LINE: sealed override int moduleInfoSizeof = new pspsharp.format.PSPModuleInfo().sizeof();
...
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x2C44F793, version = 660) public int sceKernelCreateModule_660()
		...
		/// <returns> 0 on success. </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x37E6F41B, version = 660) public int sceKernelGetModuleIdListForKernel_660(pspsharp.HLE.TPointer32 modIdList, int size, pspsharp.HLE.TPointer32 modCount, bool userModsOnly)
