...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x1605847F, version = 150) public bool sceSysconIsLowBattery()
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x48448373, version = 150) public int sceSysconCtrlWlanPower(bool power)
...
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x8CBC7987, version = 150) public int sceSysconResetDevice(int reset, int mode)
		...
		/// <returns> 0 on success. </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x1088ABA8, version = 150) public int sceSysconCtrlMsPower(bool power)
		...
		/// <returns> 1 if powered, 0 otherwise </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x577C5771, version = 660) public bool sceSysconGetLeptonPowerCtrl()
		...
		/// <returns> 0 on success. </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x8A4519F5, version = 660) public int sceSysconCtrlLeptonPower(bool power)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x18BFBE65, version = 150) public int sceSysconCtrlLED(int led, bool state)
...
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x992C22C2, version = 150) public int sceSysconSendSetParam(int id, @BufferInfo(lengthInfo=pspsharp.HLE.BufferInfo.LengthInfo.fixedLength, Length=8, usage=pspsharp.HLE.BufferInfo.Usage.in) pspsharp.HLE.TPointer param)
		...
		/// <returns>       < 0 on error  </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x44439604, version = 150) public int sceSysconCtrlHRPower(bool power)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0xA3406117, version = 150) public bool sceSysconIsAcSupplied()
