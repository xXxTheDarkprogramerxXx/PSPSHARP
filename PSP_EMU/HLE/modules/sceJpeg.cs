...
//	import static pspsharp.memory.ImageReader.colorARGBtoABGR;
	...
	public class sceJpeg : HLEModule
	{
		...
		protected internal Dictionary<int, System.Drawing.Bitmap> System.Drawing.Bitmaps;
		protected internal const string uidPurpose = "sceJpeg-System.Drawing.Bitmap";
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		protected internal const bool dumpJpegFile_Renamed = false;

		public override void start()
		{
			System.Drawing.Bitmaps = new Dictionary<int, System.Drawing.Bitmap>();
			base.start();
		}

		public override void stop()
		{
			System.Drawing.Bitmaps.Clear();
			base.stop();
		}
		...
		protected internal static System.Drawing.Bitmap readJpegImage(TPointer jpegBuffer, int jpegBufferSize)
		{
		...
		protected internal virtual void decodeImage(TPointer imageBuffer, System.Drawing.Bitmap System.Drawing.Bitmap, int width, int height, int bufferWidth, int pixelFormat, int startLine)
		{
			width = System.Math.Min(width, System.Drawing.Bitmap.Width);
			height = System.Math.Min(height, System.Drawing.Bitmap.Height);
			...
			for (int y = 0; y < height; y++)
			{
				...
				{
					int argb = System.Drawing.Bitmap.getRGB(x, y + startLine);
		...
		public virtual int hleGetYCbCrBufferSize(System.Drawing.Bitmap System.Drawing.Bitmap)
		{
			// Return necessary buffer size for conversion: 12 bits per pixel
			return ((System.Drawing.Bitmap.Width * System.Drawing.Bitmap.Height) >> 1) * 3;
		}
		...
		/// "
		/// </summary>
		/// <param name="System.Drawing.Bitmap">		the source image. </param>
		...
		public virtual int hleJpegDecodeYCbCr(System.Drawing.Bitmap System.Drawing.Bitmap, TPointer yCbCrBuffer, int yCbCrBufferSize, int dhtMode)
		{
			int width = System.Drawing.Bitmap.Width;
			int height = System.Drawing.Bitmap.Height;
			...
			for (int y = 0; y < height; y++)
			{
				...
				{
					int argb0 = System.Drawing.Bitmap.getRGB(x, y);
					int yCbCr0 = colorARGBToYCbCr(argb0);
					int argb1 = System.Drawing.Bitmap.getRGB(x + 1, y);
		...
		{
			System.Drawing.Bitmap System.Drawing.Bitmap = readJpegImage(jpegBuffer, jpegBufferSize);
			if (System.Drawing.Bitmap == null)
			{
				yCbCrBuffer.clear(yCbCrBufferSize);
				return getWidthHeight(0, 0);
			}

			return hleJpegDecodeYCbCr(System.Drawing.Bitmap, yCbCrBuffer, yCbCrBufferSize, dhtMode);
		}
		...
		public virtual int sceJpegDecodeMJpeg(TPointer jpegBuffer, int jpegBufferSize, TPointer imageBuffer, int dhtMode)
		{
			...
			{
				decodeImage(imageBuffer, System.Drawing.Bitmap, jpegWidth, jpegHeight, jpegWidth, pixelFormat, 0);
			}
...
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x8F2BB012, version = 271) public int sceJpegGetOutputInfo(pspsharp.HLE.TPointer jpegBuffer, int jpegBufferSize, @CanBeNull pspsharp.HLE.TPointer32 colorInfoBuffer, int dhtMode)
		...
		public virtual int sceJpegGetOutputInfo(TPointer jpegBuffer, int jpegBufferSize, TPointer32 colorInfoBuffer, int dhtMode)
		{
			...
			return hleGetYCbCrBufferSize(System.Drawing.Bitmap);
		}
		...
		public virtual int sceJpegDecodeMJpegSuccessively(TPointer jpegBuffer, int jpegBufferSize, TPointer imageBuffer, int dhtMode)
		{
			...
			{
				decodeImage(imageBuffer, System.Drawing.Bitmap, jpegWidth, jpegHeight, jpegWidth, pixelFormat, 0);
				width = System.Drawing.Bitmap.Width;
				height = System.Drawing.Bitmap.Height;
			}
