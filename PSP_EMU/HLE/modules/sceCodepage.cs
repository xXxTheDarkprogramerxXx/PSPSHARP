...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x11123ED1, version = 150) public bool sceCodepage_driver_11123ED1(int char16)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x014E0C72, version = 150) public bool sceCodepage_driver_014E0C72(@BufferInfo(lengthInfo=pspsharp.HLE.BufferInfo.LengthInfo.fixedLength, Length=2, usage=pspsharp.HLE.BufferInfo.Usage.in) pspsharp.HLE.TPointer8 srcAddr)
