...
//ORIGINAL LINE: sealed override byte[] xorInputKey = getKey(new int[] { 0xB04D85AA, 0xEB47CAFF, 0xE4D77F38, 0x10B0623D });
			sbyte[] xorInputKey = getKey(new int[] {unchecked((int)0xB04D85AA), unchecked((int)0xEB47CAFF), unchecked((int)0xE4D77F38), 0x10B0623D});
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override byte[] xorOutputKey = getKey(new int[] { 0x31A8F671, 0x1EFFE01E, 0xD26CBA50, 0x2DD62D98 });
			sbyte[] xorOutputKey = getKey(new int[] {0x31A8F671, 0x1EFFE01E, unchecked((int)0xD26CBA50), 0x2DD62D98});
			const int outSize = 0xD0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override byte[] tmpBuffer = new byte[0x14 + outSize];
...
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x6192F715, version = 660) public int memlmd_6192F715(@BufferInfo(lengthInfo=pspsharp.HLE.BufferInfo.LengthInfo.nextParameter, usage=pspsharp.HLE.BufferInfo.Usage.inout, maxDumpLength=512) pspsharp.HLE.TPointer buffer, int size)
		 ...
		 */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x9D36A439, version = 660) public bool memlmd_9D36A439(int subType)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @HLEUnimplemented @HLEFunction(nid = 0x2AE425D2, version = 660) public bool memlmd_2AE425D2(int subType)
