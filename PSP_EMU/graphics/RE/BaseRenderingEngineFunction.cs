...
//	import static pspsharp.util.Utilities.matrixMult;
	...
	public class BaseRenderingEngineFunction : BaseRenderingEngineProxy
	{
		...
		public override void setColorMask(int redMask, int greenMask, int blueMask, int alphaMask)
		{
			...
			// bool alphaWriteEnabled = getBooleanColorMask("Alpha mask", alphaMask);
...
//ORIGINAL LINE: sealed override float[] modelViewMatrix = new float[16];
				float[] modelViewMatrix = new float[16];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] modelViewProjectionMatrix = new float[16];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float viewportX = context.viewport_cx - context.offset_x;
				float viewportX = context.viewport_cx - context.offset_x;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float viewportY = context.viewport_cy - context.offset_y;
				float viewportY = context.viewport_cy - context.offset_y;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float viewportWidth = context.viewport_width;
				float viewportWidth = context.viewport_width;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float viewportHeight = context.viewport_height;
				float viewportHeight = context.viewport_height;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] mvpVertex = new float[4];
