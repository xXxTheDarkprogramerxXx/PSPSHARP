...
//ORIGINAL LINE: public void render(sealed override BasePrimitiveRenderer renderer)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static void doRenderStart(sealed override BasePrimitiveRenderer renderer)
...
//ORIGINAL LINE: sealed override PrimitiveState prim = renderer.prim;
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static void doRenderEnd(sealed override BasePrimitiveRenderer renderer)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static IRandomTextureAccess resampleTexture(sealed override BasePrimitiveRenderer renderer)
...
//JAVA TO C# CONVERTER WARNING: 'sealed override' parameters are not available in .NET:
//ORIGINAL LINE: private static void doRender(sealed override BasePrimitiveRenderer renderer)
		private static void doRender(BasePrimitiveRenderer renderer)
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override PixelState pixel = renderer.pixel;
			PixelState pixel = renderer.pixel;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override PrimitiveState prim = renderer.prim;
			PrimitiveState prim = renderer.prim;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override IRendererWriter rendererWriter = renderer.rendererWriter;
			IRendererWriter rendererWriter = renderer.rendererWriter;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override Lighting lighting = renderer.lighting;
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int alphaRef = renderer.alphaRef;
			int alphaRef = renderer.alphaRef;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int primSourceDepth = (int) prim.p2z;
			...
			int depthOffset = 0;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int[] memInt = pspsharp.Allegrex.compiler.RuntimeContext.getMemoryInt();
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] V = pixel.getV();
													float[] V = pixel.V;
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] normalizedN = pixel.getNormalizedN();
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] N = pixel.getN();
													float[] N = pixel.N;
										...
										case GeCommands.TMAP_TEXTURE_MAP_MODE_ENVIRONMENT_MAP:
											...
											//
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] Ve = new float[3];
											float[] Ve = new float[3];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] Ne = new float[3];
											float[] Ne = new float[3];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] Lu = new float[3];
											float[] Lu = new float[3];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override float[] Lv = new float[3];
