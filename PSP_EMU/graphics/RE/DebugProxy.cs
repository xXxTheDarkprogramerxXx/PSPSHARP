...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public override void enableFlag(int flag)
		{
			if (isLogDebugEnabled)
			{
				...
				{
					System.Console.WriteLine(string.Format("enableFlag {0}", context.flags[flag].ToString()));
				}
				else
				{
					System.Console.WriteLine(string.Format("enableFlag {0:D}", flag));
				}
			}
		...
		public override void disableFlag(int flag)
		{
			if (isLogDebugEnabled)
			{
				if (flag < context.flags.Count)
				{
					System.Console.WriteLine(string.Format("disableFlag {0}", context.flags[flag].ToString()));
				}
				else
				{
					System.Console.WriteLine(string.Format("disableFlag {0:D}", flag));
				}
			}
		...
		public override void setAlphaFunc(int func, int @ref, int mask)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setAlphaFunc func={0:D}, ref=0x{1:X2}, mask=0x{2:X2}", func, @ref, mask));
			}
		...
		public override void setTextureFunc(int func, bool alphaUsed, bool colorDoubled)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTextureFunc func={0:D}{1}{2}", func, alphaUsed ? " ALPHA" : "", colorDoubled ? " COLORx2" : ""));
			}
		...
		public override void setBlendFunc(int src, int dst)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setBlendFunc src={0:D}, dst={1:D}", src, dst));
			}
		...
		public override float[] BlendColor
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setBlendColor color=0x{0:X8}", PixelColor.getColor(value)));
				}
		...
		public override int BlendEquation
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setBlendEquation mode={0:D}", value));
				}
		...
		protected internal virtual void debugMatrix(string name, float[] matrix, int offset)
		{
			...
			for (int y = 0; y < 4; y++)
			{
				System.Console.WriteLine(string.Format("{0} {1:F3} {2:F3} {3:F3} {4:F3}", name, matrix[offset + 0 + y * 4], matrix[offset + 1 + y * 4], matrix[offset + 2 + y * 4], matrix[offset + 3 + y * 4]));
			}
		}
		...
		public override int TextureMipmapMinLevel
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setTextureMipmapMinLevel {0:D}", value));
				}
		...
		public override int TextureMipmapMaxLevel
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setTextureMipmapMaxLevel {0:D}", value));
				}
		...
		public override int TextureMipmapMinFilter
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setTextureMipmapMinFilter {0:D}", value));
				}
		...
		public override int TextureMipmapMagFilter
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setTextureMipmapMagFilter {0:D}", value));
				}
		...
		public override void setPixelStore(int rowLength, int alignment)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setPixelStore rowLength={0:D}, alignment={1:D}", rowLength, alignment));
			}
		...
		public override void setCompressedTexImage(int level, int internalFormat, int width, int height, int compressedSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setCompressedTexImage level={0:D}, internalFormat={1:D}, {2:D}x{3:D}, compressedSize=0x{4:X}", level, internalFormat, width, height, compressedSize));
			}
		...
		public override void setTexImage(int level, int internalFormat, int width, int height, int format, int type, int textureSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTexImage level={0:D}, internalFormat={1:D}, {2:D}x{3:D}, format={4:D}, type={5:D}, textureSize={6:D}", level, internalFormat, width, height, format, type, textureSize));
			}
...
//ORIGINAL LINE: System.Console.WriteLine(String.format("startClearMode color=%b, stencil=%b, depth=%b", color, stencil, depth));
				System.Console.WriteLine(string.Format("startClearMode color=%b, stencil=%b, depth=%b", color, stencil, depth));
			}
		...
		public override void endClearMode()
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine("endClearMode");
			}
			base.endClearMode();
		}
		...
		public override void startDirectRendering(bool textureEnabled, bool depthWriteEnabled, bool colorWriteEnabled, bool setOrthoMatrix, bool orthoInverted, int width, int height)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
//ORIGINAL LINE: System.Console.WriteLine(String.format("startDirectRendering texture=%b, depth=%b, color=%b, ortho=%b, inverted=%b, %dx%d", textureEnabled, depthWriteEnabled, colorWriteEnabled, setOrthoMatrix, orthoInverted, width, height));
				System.Console.WriteLine(string.Format("startDirectRendering texture=%b, depth=%b, color=%b, ortho=%b, inverted=%b, %dx%d", textureEnabled, depthWriteEnabled, colorWriteEnabled, setOrthoMatrix, orthoInverted, width, height));
			}
		...
		public override void endDirectRendering()
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine("endDirectRendering");
			}
		...
		public override void bindTexture(int texture)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("bindTexture {0:D}", texture));
			}
		...
		public override void drawArrays(int type, int first, int count)
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("drawArrays type={0:D}, first={1:D}, count={2:D}", type, first, count));
			}
		...
		public override void drawArraysBurstMode(int type, int first, int count)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("drawArraysBurstMode type={0:D}, first={1:D}, count={2:D}", type, first, count));
			}
		...
		public override int DepthFunc
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setDepthFunc {0:D}", value));
				}
		...
		public override bool DepthMask
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setDepthMask {0}", getEnabledDisabled(value)));
				}
		...
		public override void setDepthRange(float zpos, float zscale, int near, int far)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setDepthRange zpos={0:F}, zscale={1:F}, near=0x{2:X4}, far=0x{3:X4}", zpos, zscale, near, far));
			}
		...
		public override void setStencilFunc(int func, int @ref, int mask)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setStencilFunc func={0:D}, ref=0x{1:X2}, mask=0x{2:X2}", func, @ref, mask));
			}
		...
		public override void setStencilOp(int fail, int zfail, int zpass)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setStencilOp fail={0:D}, zfail={1:D}, zpass={2:D}", fail, zfail, zpass));
			}
		...
		public override int setBones(int count, float[] values)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setBones count={0:D}", count));
		...
		public override void setUniformMatrix4(int id, int count, float[] values)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniformMatrix4 id={0:D}, count={1:D}", id, count));
				for (int i = 0; i < count; i++)
				{
		...
		public override void enableVertexAttribArray(int id)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("enableVertexAttribArray {0:D}", id));
			}
		...
		public override void disableVertexAttribArray(int id)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("disableVertexAttribArray {0:D}", id));
			}
		...
		public override void setUniform(int id, float value)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform {0}={1:F}", getUniformName(id), value));
			}
		...
		public override void setUniform(int id, int value1, int value2)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform {0}={1:D}, {2:D}", getUniformName(id), value1, value2));
			}
		...
		public override void setUniform2(int id, int[] values)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform2 {0}={1:D}, {2:D}", getUniformName(id), values[0], values[1]));
			}
		...
		public override void setUniform3(int id, int[] values)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform3 {0}={1:D}, {2:D}, {3:D}", getUniformName(id), values[0], values[1], values[2]));
			}
		...
		public override void setUniform4(int id, int[] values)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform4 {0}={1:D}, {2:D}, {3:D}, {4:D}", getUniformName(id), values[0], values[1], values[2], values[3]));
			}
		...
		public override void setUniform(int id, int value)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform {0}={1:D}", getUniformName(id), value));
			}
			base.setUniform(id, value);
		}
		...
		public override void setVertexAttribPointer(int id, int size, int type, bool normalized, int stride, int bufferSize, Buffer buffer)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
//ORIGINAL LINE: System.Console.WriteLine(String.format("setVertexAttribPointer id=%d, size=%d, type=%d, normalized=%b, stride=%d, bufferSize=%d", id, size, type, normalized, stride, bufferSize));
				System.Console.WriteLine(string.Format("setVertexAttribPointer id=%d, size=%d, type=%d, normalized=%b, stride=%d, bufferSize=%d", id, size, type, normalized, stride, bufferSize));
			}
		...
		public override void setVertexAttribPointer(int id, int size, int type, bool normalized, int stride, long offset)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
//ORIGINAL LINE: System.Console.WriteLine(String.format("setVertexAttribPointer id=%d, size=%d, type=%d, normalized=%b, stride=%d, offset=%d", id, size, type, normalized, stride, offset));
				System.Console.WriteLine(string.Format("setVertexAttribPointer id=%d, size=%d, type=%d, normalized=%b, stride=%d, offset=%d", id, size, type, normalized, stride, offset));
			}
		...
		public override void enableClientState(int type)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("enableClientState {0:D}", type));
			}
		...
		public override void disableClientState(int type)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("disableClientState {0:D}", type));
			}
		...
		public override void setColorMask(bool redWriteEnabled, bool greenWriteEnabled, bool blueWriteEnabled, bool alphaWriteEnabled)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setColorMask red {0}, green {1}, blue {2}, alpha {3}", getEnabledDisabled(redWriteEnabled), getEnabledDisabled(greenWriteEnabled), getEnabledDisabled(blueWriteEnabled), getEnabledDisabled(alphaWriteEnabled)));
			}
		...
		public override void setColorMask(int redMask, int greenMask, int blueMask, int alphaMask)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setColorMask red 0x{0:X2}, green 0x{1:X2}, blue 0x{2:X2}, alpha 0x{3:X2}", redMask, greenMask, blueMask, alphaMask));
			}
		...
		public override void setTextureWrapMode(int s, int t)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTextureWrapMode {0:D}, {1:D}", s, t));
			}
		...
		public override void deleteTexture(int texture)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("deleteTexture {0:D}", texture));
			}
		...
		public override void endDisplay()
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("endDisplay"));
			}
			base.endDisplay();
		}
		...
		public override int genTexture()
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("genTexture {0:D}", value));
			}
			return value;
		}
		...
		public override void startDisplay()
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("startDisplay"));
			}
			base.startDisplay();
		}
		...
		public override void setTextureMapMode(int mode, int proj)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTextureMapMode mode={0:D}, proj={1:D}", mode, proj));
			}
		...
		public override bool FrontFace
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setFrontFace {0}", value ? "clockwise" : "counter-clockwise"));
				}
		...
		public override void setColorPointer(int size, int type, int stride, int bufferSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setColorPointer size={0:D}, type={1:D}, stride={2:D}, bufferSize={3:D}, buffer offset={4:D}", size, type, stride, bufferSize, buffer.position()));
			}
		...
		public override void setColorPointer(int size, int type, int stride, long offset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setColorPointer size={0:D}, type={1:D}, stride={2:D}, offset={3:D}", size, type, stride, offset));
			}
		...
		public override void setNormalPointer(int type, int stride, int bufferSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setNormalPointer type={0:D}, stride={1:D}, bufferSize={2:D}, buffer offset={3:D}", type, stride, bufferSize, buffer.position()));
			}
		...
		public override void setNormalPointer(int type, int stride, long offset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setNormalPointer type={0:D}, stride={1:D}, offset={2:D}", type, stride, offset));
			}
		...
		public override void setTexCoordPointer(int size, int type, int stride, int bufferSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTexCoordPointer size={0:D}, type={1:D}, stride={2:D}, bufferSize={3:D}, buffer offset={4:D}", size, type, stride, bufferSize, buffer.position()));
			}
		...
		public override void setTexCoordPointer(int size, int type, int stride, long offset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTexCoordPointer size={0:D}, type={1:D}, stride={2:D}, offset={3:D}", size, type, stride, offset));
			}
		...
		public override void setVertexPointer(int size, int type, int stride, int bufferSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setVertexPointer size={0:D}, type={1:D}, stride={2:D}, bufferSize={3:D}, buffer offset={4:D}", size, type, stride, bufferSize, buffer.position()));
			}
		...
		public override void setVertexPointer(int size, int type, int stride, long offset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setVertexPointer size={0:D}, type={1:D}, stride={2:D}, offset={3:D}", size, type, stride, offset));
			}
		...
		public override void setWeightPointer(int size, int type, int stride, int bufferSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setWeightPointer size={0:D}, type={1:D}, stride={2:D}, bufferSize={3:D}, buffer offset={4:D}", size, type, stride, bufferSize, buffer.position()));
			}
		...
		public override void setWeightPointer(int size, int type, int stride, long offset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setWeightPointer size={0:D}, type={1:D}, stride={2:D}, offset={3:D}", size, type, stride, offset));
			}
		...
		public override void setBufferData(int target, int size, Buffer buffer, int usage)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setBufferData target={0:D}, size={1:D}, buffer size={2:D}, usage={3:D}", target, size, buffer == null ? 0 : buffer.capacity(), usage));
			}
		...
		public override void setBufferSubData(int target, int offset, int size, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setBufferSubData target={0:D}, offset={1:D}, size={2:D}, buffer size={3:D}", target, offset, size, buffer == null ? 0 : buffer.capacity()));
			}
		...
		public override void bindBuffer(int target, int buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("bindBuffer {0:D}, {1:D}", target, buffer));
			}
		...
		public override void useProgram(int program)
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("useProgram {0:D}", program));
			}
		...
		public override void setViewport(int x, int y, int width, int height)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setViewport x={0:D}, y={1:D}, width={2:D}, height={3:D}", x, y, width, height));
			}
		...
		public override void setScissor(int x, int y, int width, int height)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setScissor x={0:D}, y={1:D}, width={2:D}, height={3:D}", x, y, width, height));
			}
		...
		public override void setTexSubImage(int level, int xOffset, int yOffset, int width, int height, int format, int type, int textureSize, Buffer buffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setTexSubImage level={0:D}, xOffset={1:D}, yOffset={2:D}, width={3:D}, height={4:D}, format={5:D}, type={6:D}, textureSize={7:D}", level, xOffset, yOffset, width, height, format, type, textureSize));
			}
		...
		public override void copyTexSubImage(int level, int xOffset, int yOffset, int x, int y, int width, int height)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("copyTexSubImage level={0:D}, xOffset={1:D}, yOffset={2:D}, x={3:D}, y={4:D}, width={5:D}, height={6:D}", level, xOffset, yOffset, x, y, width, height));
			}
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
				System.Console.WriteLine(string.Format("getTexImage level={0:D}, format={1:D}, type={2:D}, buffer remaining={3:D}, buffer class={4}", level, format, type, buffer.remaining(), buffer.GetType().FullName));
			}
		...
		public override void bindVertexArray(int id)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("bindVertexArray {0:D}", id));
			}
		...
		public override void multiDrawArrays(int primitive, IntBuffer first, IntBuffer count)
		{
			if (isLogDebugEnabled)
			{
				...
				System.Console.WriteLine(string.Format("multiDrawArrays primitive={0:D}, count={1:D},{2}", primitive, n, s.ToString()));
			}
		...
		public override int ActiveTexture
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setActiveTexture {0:D}", value));
				}
		...
		public override void setTextureFormat(int pixelFormat, bool swizzle)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
//ORIGINAL LINE: System.Console.WriteLine(String.format("setTextureFormat pixelFormat=%d(%s), swizzle=%b", pixelFormat, pspsharp.graphics.VideoEngine.getPsmName(pixelFormat), swizzle));
				System.Console.WriteLine(string.Format("setTextureFormat pixelFormat=%d(%s), swizzle=%b", pixelFormat, VideoEngine.getPsmName(pixelFormat), swizzle));
			}
		...
		public override int createProgram()
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("createProgram {0:D}", program));
			}
			return program;
		}
		...
		public override float[] VertexColor
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setVertexColor (r={0:F3}, b={1:F3}, g={2:F3}, a={3:F3})", value[0], value[1], value[2], value[3]));
				}
		...
		public override void setUniform4(int id, float[] values)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setUniform4 {0}={1:F}, {2:F}, {3:F}, {4:F}", getUniformName(id), values[0], values[1], values[2], values[3]));
			}
			base.setUniform4(id, values);
		}
		...
		public override void setColorMaterial(bool ambient, bool diffuse, bool specular)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
//ORIGINAL LINE: System.Console.WriteLine(String.format("setColorMaterial ambient=%b, diffuse=%b, specular=%b", ambient, diffuse, specular));
				System.Console.WriteLine(string.Format("setColorMaterial ambient=%b, diffuse=%b, specular=%b", ambient, diffuse, specular));
			}
		...
		public override void bindFramebuffer(int target, int framebuffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("bindFramebuffer target={0:D}, framebuffer={1:D}", target, framebuffer));
			}
		...
		public override void bindActiveTexture(int index, int texture)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("bindActiveTexture index={0:D}, texture={1:D}", index, texture));
			}
		...
		public override void blitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, int mask, int filter)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("blitFramebuffer src=({0:D},{1:D})-({2:D},{3:D}), dst=({4:D},{5:D})-({6:D},{7:D}), mask=0x{8:X}, filter={9:D}", srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter));
			}
		...
		public override bool setCopyRedToAlpha(bool copyRedToAlpha)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
//ORIGINAL LINE: System.Console.WriteLine(String.format("setCopyRedToAlpha %b", copyRedToAlpha));
				System.Console.WriteLine(string.Format("setCopyRedToAlpha %b", copyRedToAlpha));
			}
		...
		public override void drawElements(int primitive, int count, int indexType, Buffer indices, int indicesOffset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("drawElements primitive={0:D}, count={1:D}, indexType={2:D}, indicesOffset={3:D}", primitive, count, indexType, indicesOffset));
			}
		...
		public override void multiDrawElements(int primitive, IntBuffer first, IntBuffer count, int indexType, long indicesOffset)
		{
			if (isLogDebugEnabled)
			{
				...
				System.Console.WriteLine(string.Format("multiDrawElements primitive={0:D}, count={1:D},{2}, indexType={3:D}, indicesOffset={4:D}", primitive, n, s.ToString(), indexType, indicesOffset));
			}
		...
		public override void drawElementsBurstMode(int primitive, int count, int indexType, long indicesOffset)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("drawElementsBurstMode primitive={0:D}, count={1:D}, indexType={2:D}, indicesOffset={3:D}", primitive, count, indexType, indicesOffset));
			}
		...
		public override int genFramebuffer()
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("genFramebuffer {0:D}", value));
			}
			return value;
		}
		...
		public override int genRenderbuffer()
		{
			...
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("genRenderbuffer {0:D}", value));
			}
			return value;
		}
		...
		public override void bindRenderbuffer(int renderbuffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("bindRenderbuffer renderbuffer={0:D}", renderbuffer));
			}
		...
		public override void setRenderbufferStorage(int internalFormat, int width, int height)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setRenderbufferStorage internalFormat={0:D}, width={1:D}, height={2:D}", internalFormat, width, height));
			}
		...
		public override void setFramebufferRenderbuffer(int target, int attachment, int renderbuffer)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setFramebufferRenderbuffer target={0:D}, attachment={1:D}, renderbuffer={2:D}", target, attachment, renderbuffer));
			}
		...
		public override void setFramebufferTexture(int target, int attachment, int texture, int level)
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine(string.Format("setFramebufferTexture target={0:D}, attachment={1:D}, texture={2:D}, level={3:D}", target, attachment, texture, level));
			}
		...
		public override void textureBarrier()
		{
			if (isLogDebugEnabled)
			{
				System.Console.WriteLine("textureBarrier");
			}
			base.textureBarrier();
		}
		...
		public override int LogicOp
		{
			set
			{
				if (isLogDebugEnabled)
				{
					System.Console.WriteLine(string.Format("setLogicOp logicOp={0:D}", value));
				}
				base.LogicOp = value;
			}
		}
