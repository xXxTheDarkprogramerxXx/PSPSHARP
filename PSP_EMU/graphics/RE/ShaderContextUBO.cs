...
//ORIGINAL LINE: @Override public void setBoneMatrix(sealed override int count, sealed override float[] boneMatrix)
...
//ORIGINAL LINE: sealed override float[] previousBoneMatrix = getBoneMatrix();
				float[] previousBoneMatrix = BoneMatrix;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int Length = 16 * count;
				int Length = 16 * count;
				int start = -1;
