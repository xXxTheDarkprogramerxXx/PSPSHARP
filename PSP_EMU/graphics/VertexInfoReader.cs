...
namespace pspsharp.graphics
{
    ...
    using static pspsharp.graphics.RE.IRenderingEngine_Fields;
    //JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//	import static pspsharp.graphics.RE.IRenderingEngine_Fields.RE_UNSIGNED_SHORT;
	...
	public class VertexInfoReader 
    {
		...
		private sealed override IVertexInfoReader[] paddingReaders = new IVertexInfoReader[] { new NotImplementedReader("Padding 0")
		...
		private sealed override IVertexInfoReader[] skip2Readers = new IVertexInfoReader[] { new NopReader()
		...
		private sealed override IVertexInfoReader[] skip3Readers = new IVertexInfoReader[] { new NopReader()
		...
		private sealed override IVertexInfoReader[] skipColorReaders = new IVertexInfoReader[] { new NopReader()
		...
		private sealed override IVertexInfoReader[] textureReaders = new IVertexInfoReader[] { new NopReader()
								, new Texture1Reader(), new Texture2Reader(), new Texture3Reader()
								 };

		// Readers reading a color element, indexed by the color type
		private sealed override IVertexInfoReader[] colorReaders = new IVertexInfoReader[] { new NopReader()
		...
		private sealed override IVertexInfoReader[] normalReaders = new IVertexInfoReader[] { new NopReader()
		...
		private sealed override IVertexInfoReader[] positionReaders = new IVertexInfoReader[] { new NopReader()
								, new Position1Reader(), new Position2Reader(), new Position3Reader()
								 };

		// Readers reading a weight element, indexed by the weight type
		private sealed override IVertexInfoReader[] weightReaders = new IVertexInfoReader[] { new NopReader()
								, new Weight1Reader(), new Weight2Reader(), new Weight3Reader()
								 };

		// Readers skipping a weight element, indexed by the weight type
		private sealed override IVertexInfoReader[] skipWeightReaders = new IVertexInfoReader[] { new NopReader()
		...
		public int TextureNumberValues
		{
            ...
            set
            {
                this.textureNumberValues = value;
            }
		...
		public int PositionNumberValues
		{
            ...
            set
            {
                this.positionNumberValues = value;
            }
		...
		/// 
		/// </summary>
		public interface IVertexDataBuffer
		{
		...
		/// 
		/// </summary>
		private static class IntVertexDataBuffer : IVertexDataBuffer
		{
			private int[] buffer;
			private int index;
			...
			public Buffer Buffer
			{
				get { return IntBuffer.wrap(buffer); }
			}
		...
		/// 
		/// </summary>
		private static class FloatVertexDataBuffer : IVertexDataBuffer
		{
		...
		/// 
		/// </summary>
		public interface IVertexInfoReader
		{
			/// <summary>
		...
		/// 
		/// </summary>
		public abstract class AbstractNativeReader : IVertexInfoReader
		{
			public void read()
			{
				// Raise error
		...
		/// 
		/// </summary>
		private abstract class AbstractSkipReader : IVertexInfoReader
		{
			public bool Native
			{
				return true;
		...
		/// 
		/// </summary>
		private class NotImplementedReader : AbstractSkipReader
		{
		...
		/// 
		/// </summary>
		private class NopReader : AbstractSkipReader
		{
			public void read()
			{
				// Nothing to do
		...
		/// 
		/// </summary>
		private class AlignShortReader : AbstractSkipReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class AlignIntReader : AbstractSkipReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class Skip2BytesReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 2 Bytes
		...
		/// 
		/// </summary>
		private class Skip3BytesReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 3 Bytes
		...
		/// 
		/// </summary>
		private class Skip1ShortReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 1 Shorts
		...
		/// 
		/// </summary>
		private class Skip2ShortsReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 2 Shorts
		...
		/// 
		/// </summary>
		private class Skip3ShortsReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 3 Shorts
		...
		/// 
		/// </summary>
		private class Skip1IntReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 1 Int
		...
		/// 
		/// </summary>
		private class Skip2FloatsReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 2 Floats
		...
		/// 
		/// </summary>
		private class Skip3FloatsReader : AbstractSkipReader
		{
			public void read()
			{
				// Skip 3 Floats
		...
		/// 
		/// </summary>
		private class Texture1Reader : IVertexInfoReader
		{
			public void read()
			{
				// Unsigned 8 bit
		...
		/// 
		/// </summary>
		private class Texture2Reader : IVertexInfoReader
		{
			public void read()
			{
				// Unsigned 16 bit
		...
		/// 
		/// </summary>
		private class Texture3Reader : AbstractNativeReader
		{
			public int type()
			{
				return RE_FLOAT;
		...
		/// 
		/// </summary>
		private class Color4Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class Color5Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class Color6Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class Color7Reader : AbstractNativeReader
		{
			public int type()
			{
		...
		/// 
		/// </summary>
		private class Normal1Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class Normal2Reader : IVertexInfoReader
		{
			public void read()
			{
				// TODO Check if this value is signed like position or unsigned like texture
		...
		/// 
		/// </summary>
		private class Normal3Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		private class Position1Reader : IVertexInfoReader
		{
			public void read()
			{
				if (vertexInfo.transform2D)
		...
		/// 
		/// </summary>
		private class Position2Reader : IVertexInfoReader
		{
			public void read()
			{
				if (vertexInfo.transform2D)
		...
		/// 
		/// </summary>
		private class Position3Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		public class Weight1Reader : IVertexInfoReader
		{
			public void read()
			{
		...
		/// 
		/// </summary>
		public class Weight2Reader : IVertexInfoReader
		{
			public void read()
			{
				for (int i = 0; i < vertexInfo.skinningWeightCount; i++)
		...
		/// 
		/// </summary>
		public class Weight3Reader : IVertexInfoReader
		{
			public void read()
			{
				for (int i = 0; i < vertexInfo.skinningWeightCount; i++)
		...
		/// 
		/// </summary>
		private class SkipWeight1Reader : AbstractSkipReader
		{
			public void read()
			{
				// Skip Weight Bytes
		...
		/// 
		/// </summary>
		private class SkipWeight2Reader : AbstractSkipReader
		{
			public void read()
			{
				// Skip Weight Shorts
		...
		/// 
		/// </summary>
		private class SkipWeight3Reader : AbstractSkipReader
		{
			public void read()
			{
				// Skip Weight Floats
