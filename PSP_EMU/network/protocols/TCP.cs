...
//	import static pspsharp.network.protocols.InternetChecksum.computeInternetChecksum;
	...
	public class TCP
	{
		...
		public bool flagURG; // indicates that the Urgent pointer FieldInfo is significant
		public bool flagACK; // indicates that the Acknowledgment FieldInfo is significant
