...
//ORIGINAL LINE: sealed override int vsize = context.getVsize();
		int vsize = context.Vsize;
		if (vsize == 4)
		{
			MethodVisitor mv = context.MethodVisitor;
	...
	public override void compile(ICompilerContext context, int insn)
	{
		const int vsize = 1;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int vd = context.getVtRegisterIndex();
...
//ORIGINAL LINE: sealed override int vd = context.getVtRegisterIndex();
		int vd = context.VtRegisterIndex; // vd index stored as vt
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int imm16 = context.getImm16(false);
	...
	public override void compile(ICompilerContext context, int insn)
	{
		const int vsize = 3;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int vs = context.getVsRegisterIndex();
		int vs = context.VsRegisterIndex;
		MethodVisitor mv = context.MethodVisitor;
...
//ORIGINAL LINE: sealed override int vs = context.getVsRegisterIndex();
			int vs = context.VsRegisterIndex;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int vd = context.getVdRegisterIndex();
			int vd = context.VdRegisterIndex;
			context.startPfxCompiled();
			context.loadVt(1, 0);
			context.storeFTmp1();
