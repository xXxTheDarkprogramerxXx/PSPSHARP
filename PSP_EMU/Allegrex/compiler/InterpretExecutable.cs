...
//ORIGINAL LINE: sealed override pspsharp.Allegrex.Common.Instruction[] insns = codeBlock.getInterpretedInstructions();
				Instruction[] insns = codeBlock.InterpretedInstructions;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'sealed override':
//ORIGINAL LINE: sealed override int[] opcodes = codeBlock.getInterpretedOpcodes();
