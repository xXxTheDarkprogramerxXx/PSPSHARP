...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static int syscallFast(int code, bool inDelaySlot) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static int syscall(int code, bool inDelaySlot) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static int syscallLLE(int code, bool inDelaySlot) throws Exception
