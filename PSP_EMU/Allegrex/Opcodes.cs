...
namespace pspsharp.Allegrex
{
	...
	// CPU: encoded by opcode FieldInfo.
	//
	//     31---------26---------------------------------------------------0
	//     |  opcode   |                                                   |
	//     ------6----------------------------------------------------------
	...
	//      *VFPU7 check VFPU7 table
		...
		public const sbyte VFPU7 = 0x3f; // SPECIAL: encoded by function FieldInfo when opcode FieldInfo = SPECIAL
	//
	//     31---------26------------------------------------------5--------0
	//     |=   SPECIAL|                                         | function|
	//     ------6----------------------------------------------------6-----
	...
	// SPECIAL rs : encoded by rs FieldInfo when opcode/func FieldInfo = SPECIAL/SRLROR
	//
	//     31---------26-----21-----------------------------------5--------0
	//     |=   SPECIAL| rs  |                                    |= SRLROR|
	//     ------6--------5-------------------------------------------6-----
	...
	//  hi |-------|-------|-------|-------|-------|-------|-------|-------|
		...
		public const sbyte ROTR = 0x1; // SPECIAL sa : encoded by sa FieldInfo when opcode/func FieldInfo = SPECIAL/SRLRORV
	//
	//     31---------26------------------------------------10----5--------0
	//     |=   SPECIAL|                                    | sa  |=SRLRORV|
	//     ------6---------------------------------------------5------6-----
	...
	//     REGIMM: encoded by the rt FieldInfo when opcode FieldInfo = REGIMM.
	//     31---------26----------20-------16------------------------------0
	//     |=    REGIMM|          |   rt    |                              |
	//     ------6---------------------5------------------------------------
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     COP0: encoded by the rs FieldInfo when opcode FieldInfo = COP0.
	//     31---------26----------23-------31------------------------------0
	//     |=      COP0|          |   rs    |                              |
	//     ------6---------------------5------------------------------------
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     *1 COP0 func
		...
		public const sbyte COP0ERET = 0x10; //     COP0: encoded by the func FieldInfo when opcode/rs FieldInfo = COP0/10000.
	//     31---------26------------------------------------------5--------0
	//     |=      COP0|                                         | function|
	//     ------6----------------------------------------------------6-----
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     SPECIAL2 : encoded by function FieldInfo when opcode FieldInfo = SPECIAL2
	//     31---------26------------------------------------------5--------0
	//     |=  SPECIAL2|                                         | function|
	//     ------6----------------------------------------------------6-----
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     SPECIAL3: encoded by function FieldInfo when opcode FieldInfo = SPECIAL3
	//     31---------26------------------------------------------5--------0
	//     |=  SPECIAL3|                                         | function|
	//     ------6----------------------------------------------------6-----
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	// 111 |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |  ---  |
	//  hi |-------|-------|-------|-------|-------|-------|-------|-------|
	//       * 1 BSHFL encoding based on sa FieldInfo
		public const sbyte EXT = 0x0; // extract bit FieldInfo
		public const sbyte INS = 0x4; // insert bit FieldInfo
		public const sbyte BSHFL = 0x20; //BSHFL table
	//     BSHFL: encoded by the sa FieldInfo.
	//     31---------26----------20-------16--------------8---6-----------0
	//     |          |          |         |               | sa|           |
	//     ------6---------------------5------------------------------------
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     COP1: encoded by the rs FieldInfo when opcode FieldInfo = COP1.
	//     31-------26------21---------------------------------------------0
	//     |=    COP1|  rs  |                                              |
	//     -----6-------5---------------------------------------------------
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     COP1BC: encoded by the rt FieldInfo
	//     31---------21-------16------------------------------------------0
	//     |=    COP1BC|  rt   |                                           |
	//     ------11---------5-----------------------------------------------
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     COP1S: encoded by function FieldInfo
	//     31---------21------------------------------------------5--------0
	//     |=  COP1S  |                                          | function|
	//     -----11----------------------------------------------------6-----
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
	...
	//     COP1W: encoded by function FieldInfo
	//     31---------21------------------------------------------5--------0
	//     |=  COP1W  |                                          | function|
	//     -----11----------------------------------------------------6-----
	//     |--000--|--001--|--010--|--011--|--100--|--101--|--110--|--111--| lo
