	...
	public class LsuState : MduState
	{
		...
		public virtual void doLH(int rt, int rs, int simm16)
		{
			if (CHECK_ALIGNMENT)
			{
				...
				if ((address & 1) != 0)
				{
					Memory.System.Console.WriteLine(string.Format("LH unaligned addr:0x{0:x8} pc:0x{1:x8}", address, cpu.pc));
				}
			}
		...
		public virtual void doLHU(int rt, int rs, int simm16)
		{
			if (CHECK_ALIGNMENT)
			{
				...
				if ((address & 1) != 0)
				{
					Memory.System.Console.WriteLine(string.Format("LHU unaligned addr:0x{0:x8} pc:0x{1:x8}", address, cpu.pc));
				}
			}
		...
		public virtual void doLW(int rt, int rs, int simm16)
		{
			if (CHECK_ALIGNMENT)
			{
				...
				if ((address & 3) != 0)
				{
					Memory.System.Console.WriteLine(string.Format("LW unaligned addr:0x{0:x8} pc:0x{1:x8}", address, cpu.pc));
				}
			}
		...
		public virtual void doSH(int rt, int rs, int simm16)
		{
			if (CHECK_ALIGNMENT)
			{
				...
				if ((address & 1) != 0)
				{
					Memory.System.Console.WriteLine(string.Format("SH unaligned addr:0x{0:x8} pc:0x{1:x8}", address, cpu.pc));
				}
			}
		...
		public virtual void doSW(int rt, int rs, int simm16)
		{
			if (CHECK_ALIGNMENT)
			{
				...
				if ((address & 3) != 0)
				{
					Memory.System.Console.WriteLine(string.Format("SW unaligned addr:0x{0:x8} pc:0x{1:x8}", address, cpu.pc));
				}
			}
