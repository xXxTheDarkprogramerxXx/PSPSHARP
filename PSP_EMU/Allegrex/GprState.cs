...
namespace pspsharp.Allegrex
{
	...
	public class GprState : IState
	{
		...
		public virtual int getRegister(int reg)
		{
			...
			Emulator.System.Console.WriteLine(string.Format("Unknown register {0:D}", reg));
			return 0;
		}
		...
		public virtual void setRegister(int reg, int value)
		{
			...
			Emulator.System.Console.WriteLine(string.Format("Unknown register {0:D}, value=0x{1:X8}", reg, value));
		}
...
//ORIGINAL LINE: @Override public void write(pspsharp.state.StateOutputStream stream) throws java.io.IOException
		...
		{
			Emulator.System.Console.WriteLine("Interpreter : " + reason);
		}
		...
		// not sure about it
		//public static sealed override int unsignedCompare(int i, int j) {
		//    return (i - j) >>> 31;
		//}
