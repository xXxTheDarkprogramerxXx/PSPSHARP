...
public interface DataInput
{
    ...
    /// </para>
    /// following conditions occurs:<para>
    /// <ul>
    ...
    /// </summary>
    /// <returns>     the <code>bool</code> value read. </returns>
    /// <exception cref="EOFException">  if this stream reaches the end before reading
    ///               all the bytes. </exception>
    /// <exception cref="IOException">   if an I/O error occurs. </exception>
    //JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
    //ORIGINAL LINE: bool readBoolean() throws IOException;
    bool readBoolean();
    ...
    /// returned
    /// is:
    /// <para><pre><code>(short)((a &lt;&lt; 8) | (b &amp; 0xff))
    /// </code></pre>
    /// This method
